...
\begin{outerlist}
\item Design and conduct biochemistry and chemical biology experiments to investigate FRET biosensors, Cholesterol oxidase depletion system, and Cholesterol signaling. 
\end{outerlist}
\vspace{.1in}
